...
<body class="page-header-fixed">
    ...
    <div class="page-container">
                ...
                <ul class="page-sidebar-menu">
                    ...
                    <li class="start active ">
                        <a href="{{route('categories.index')}}">
                            <i class="icon-home"></i>
                            <span class="title">Master Categories</span>
        ...
        <div class="page-content-wrapper">
            <div class="page-content" style="min-height:725px">
                @yield('content')
            </div>
        </div>
        <!-- END CONTENT -->
    ...
    <script src="{{asset('conquer/plugins/jquery-ui/jquery-ui-1.10.3.custom.min.js')}}" type="text/javascript">
    </script>
    ...
    <script src="{{asset('conquer/plugins/jqvmap/jqvmap/maps/jquery.vmap.russia.js')}}" type="text/javascript">
    </script>
    <script src="{{asset('conquer/plugins/jqvmap/jqvmap/maps/jquery.vmap.world.js')}}" type="text/javascript"></script>
    <script src="{{asset('conquer/plugins/jqvmap/jqvmap/maps/jquery.vmap.europe.js')}}" type="text/javascript">
    </script>
    <script src="{{asset('conquer/plugins/jqvmap/jqvmap/maps/jquery.vmap.germany.js')}}" type="text/javascript">
    </script>
